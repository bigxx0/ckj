                    ...
                    <ul class="edit">
                        <div class="edit-more">
                            <div>
                                ...
                                <!-- 下拉选择分配 -->
                                <el-dropdown trigger="click">
                                    <div class="el-dropdown-link" @click="onSearch(item.orderId, item.status)">
                                        <li class="edit-li">分配</li>
                                    </div>
                                    <template #dropdown>
                                        <el-dropdown-menu class="customerList">
                                            <el-dropdown-item v-for="(item, index) in workerList" :key="index"
                            ...
                            <div>
                                <div class="el-dropdown-link">
                                    <!-- <router-link :to="{ path: '/gdDetails' + index }">
                                        <li class="edit-li">查看详情</li>
                                    </router-link> -->
                                    <el-button type="primary" @click="toComponentTwo(index)">订单详情</el-button>
                                </div>
                            </div>
                        </div>
                    </ul>
