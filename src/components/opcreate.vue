      ...
      <div class="order">
        ...
        <el-form :model="form" label-width="120px" label-position="top">
          ...
          <el-form-item class="title" label="联系人:">
            <el-input v-model="content"  placeholder="输入联系人" clearable />
          </el-form-item>
          <el-form-item class="title" label="联系方式:">
            <el-input v-model="content"  placeholder="联系方式" clearable />
          </el-form-item>
          <el-form-item class="title" label="创建时间:">
            <el-col :span="11">
          ...
          <el-form-item class="title" label="意愿:">
            <el-input v-model="detail" autosize type="textarea" placeholder="输入意愿" clearable />
          </el-form-item>
          <el-form-item class="title" label="负责人:">
            <el-input v-model="content"  placeholder="负责人" clearable />
          </el-form-item>
          <el-form-item>
